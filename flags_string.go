...
const (
	_BufferCreateFlags_name_0 = "BufferCreateSparseBindingBitBufferCreateSparseResidencyBit"
	_BufferCreateFlags_name_1 = "BufferCreateSparseAliasedBit"
	_BufferCreateFlags_name_2 = "BufferCreateProtectedBit"
)

var (
	_BufferCreateFlags_index_0 = [...]uint8{0, 28, 58}
)

func (i BufferCreateFlags) String() string {
	switch {
	case 1 <= i && i <= 2:
		i -= 1
		return _BufferCreateFlags_name_0[_BufferCreateFlags_index_0[i]:_BufferCreateFlags_index_0[i+1]]
	case i == 4:
		return _BufferCreateFlags_name_1
	case i == 8:
		return _BufferCreateFlags_name_2
	default:
		return "BufferCreateFlags(" + strconv.FormatInt(int64(i), 10) + ")"
	}
}

const _BufferUsageFlags_name = ""

var _BufferUsageFlags_map = map[BufferUsageFlags]string{
	1:    _BufferUsageFlags_name[0:25],
	2:    _BufferUsageFlags_name[25:50],
	4:    _BufferUsageFlags_name[50:82],
	8:    _BufferUsageFlags_name[82:114],
	16:   _BufferUsageFlags_name[114:141],
	32:   _BufferUsageFlags_name[141:168],
	64:   _BufferUsageFlags_name[168:193],
	128:  _BufferUsageFlags_name[193:219],
	256:  _BufferUsageFlags_name[219:247],
	512:  _BufferUsageFlags_name[247:284],
	1024: _BufferUsageFlags_name[284:311],
	2048: _BufferUsageFlags_name[311:351],
	4096: _BufferUsageFlags_name[351:398],
}

func (i BufferUsageFlags) String() string {
	if str, ok := _BufferUsageFlags_map[i]; ok {
		return str
	}
	return "BufferUsageFlags(" + strconv.FormatInt(int64(i), 10) + ")"
}
