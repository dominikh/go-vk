...
func init() {
	...
	assertSameSize(unsafe.Sizeof(CommandBufferUsageFlags(0)), unsafe.Sizeof(C.VkCommandBufferUsageFlags(0)))
	assertSameSize(unsafe.Sizeof(QueryPipelineStatisticFlags(0)), unsafe.Sizeof(C.VkQueryPipelineStatisticFlags(0)))
	assertSameSize(unsafe.Sizeof(QueryControlFlags(0)), unsafe.Sizeof(C.VkQueryControlFlags(0)))
}
