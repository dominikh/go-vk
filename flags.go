...
func init() {
	assertSameSize(unsafe.Sizeof(DeviceQueueCreateFlags(0)), C.sizeof_VkDeviceQueueCreateFlags)
	assertSameSize(unsafe.Sizeof(QueueFlags(0)), C.sizeof_VkQueueFlags)
	assertSameSize(unsafe.Sizeof(PhysicalDeviceType(0)), C.sizeof_VkPhysicalDeviceType)
	assertSameSize(unsafe.Sizeof(Result(0)), C.sizeof_VkResult)
	assertSameSize(unsafe.Sizeof(StructureType(0)), C.sizeof_VkStructureType)
	assertSameSize(unsafe.Sizeof(SurfaceTransformFlagsKHR(0)), C.sizeof_VkSurfaceTransformFlagsKHR)
	assertSameSize(unsafe.Sizeof(CompositeAlphaFlagsKHR(0)), C.sizeof_VkCompositeAlphaFlagsKHR)
	assertSameSize(unsafe.Sizeof(ImageUsageFlags(0)), C.sizeof_VkImageUsageFlags)
	assertSameSize(unsafe.Sizeof(Format(0)), C.sizeof_VkFormat)
	assertSameSize(unsafe.Sizeof(ColorSpaceKHR(0)), C.sizeof_VkColorSpaceKHR)
	assertSameSize(unsafe.Sizeof(PresentModeKHR(0)), C.sizeof_VkPresentModeKHR)
	assertSameSize(unsafe.Sizeof(CommandPoolCreateFlags(0)), C.sizeof_VkCommandPoolCreateFlags)
	assertSameSize(unsafe.Sizeof(CommandPoolTrimFlags(0)), C.sizeof_VkCommandPoolTrimFlags)
	assertSameSize(unsafe.Sizeof(CommandPoolResetFlags(0)), C.sizeof_VkCommandPoolResetFlags)
	assertSameSize(unsafe.Sizeof(CommandBufferLevel(0)), C.sizeof_VkCommandBufferLevel)
	assertSameSize(unsafe.Sizeof(CommandBufferResetFlags(0)), C.sizeof_VkCommandBufferResetFlags)
